RSpec.describe Comments::Operations::Show, type: :operation do
  ...
  let(:comment_repo) { instance_double('CommentRepository', find_by_task_id: comment) }
  let(:comment_policy) { instance_double('Comments::Policy', show?: policy_result) }
